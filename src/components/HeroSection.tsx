          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                ACTIVE DIRECTORY <span className="text-[#8C6D4F] mx-1">•</span> M365 <span className="text-[#8C6D4F] mx-1">•</span> NETWORKING
              </p>
            </motion.div>
            ...
            >
              <p>
                I turn complex infrastructure into intelligent cloud experiences.
                <br />
                Where servers evolve into scalable systems, data becomes insight, and technology transforms vision into impact.
              </p>
            </motion.div>
