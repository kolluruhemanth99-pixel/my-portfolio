...
const bentoCategories = [
  {
    ...
    description:
      'Building practical enterprise infrastructure skills across identity administration, Microsoft 365, Windows Server, directory services, access management, and core network services.',
    stat: 'IDENTITY + INFRA',
  ...
  },
  {
    ...
    description:
      'Working across Azure and AWS while learning how traditional server infrastructure evolves into scalable cloud platforms and services.',
    stat: 'AZURE + AWS',
  ...
  },
  {
    ...
    description:
      'Designing data pipelines and warehouse architectures from ingestion and validation through transformation, modeling, and analytics-ready datasets.',
    stat: 'SNOWFLAKE + SQL',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    description:
      'Building practical applications, web experiences, automation workflows, and engineering projects while continuously expanding across modern technology stacks.',
    stat: 'BUILD · AUTOMATE · LEARN',
    colSpan: 'lg:col-span-7',
  },
];
...
export const SkillsSection: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Ambient Glows */}
      <div className="absolute top-1/3 left-1/4 w-[34rem] h-[34rem] bg-[#D4AF37]/5 rounded-full blur-[170px] mobile-performance-blur pointer-events-none" />
      <div className="absolute bottom-10 right-1/4 w-[28rem] h-[28rem] bg-[#8C6D4F]/5 rounded-full blur-[160px] mobile-performance-blur pointer-events-none" />
