  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="absolute top-1/4 left-1/6 w-[32rem] h-[32rem] bg-[#D4AF37] rounded-full blur-[160px] mobile-performance-blur pointer-events-none"
      />
      <motion.div 
        animate={{ scale: [1.2, 1, 1.2], opacity: [0.05, 0.12, 0.05] }}
        transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute bottom-1/6 right-1/4 w-[28rem] h-[28rem] bg-[#8C6D4F] rounded-full blur-[170px] mobile-performance-blur pointer-events-none"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Hemanth Kumar Kolluru</span>,an aspiring cloud and infrastructure professional focused on identity, enterprise systems, cloud technologies, and data. My journey started with understanding servers and Active Directory and is evolving toward Azure, AWS, Snowflake, and modern cloud-based solutions. I enjoy turning complex technical challenges into reliable, scalable systems and continuously exploring what comes next.
            </motion.p>
