...
const projects: Project[] = [
  {
    number: '01',
    title: 'SmartGrid360',
    category: 'ENERGY & UTILITY DATA PLATFORM',
    description:
        'End-to-end data engineering platform for energy and utility analytics, built to ingest, validate, transform, and analyze large-scale customer, meter, consumption, billing, and outage data.',
    ...
    metrics: [
        { label: 'DOMAIN', value: 'Energy & Utilities' },
        { label: 'WAREHOUSE', value: 'Snowflake' },
        { label: 'STORAGE', value: 'AWS S3' },
        { label: 'PIPELINE', value: 'S3 → Snowpipe → RAW → STG → MART' },
    ],
},
 {
    number: '02',
    ...
    description:
        'Data engineering solutions built with Snowflake and SQL, covering data ingestion, transformation, data quality validation, dimensional modeling, and analytics-ready datasets.',
    githubUrl: 'YOUR_GITHUB_LINK_HERE',
    tech: [
        'Snowflake',
        'SQL',
    ...
    metrics: [
        { label: 'PLATFORM', value: 'Snowflake' },
        { label: 'CORE', value: 'SQL & ETL' },
  ...
  },
  {
    ...
    category: 'ENTERPRISE INFRASTRUCTURE / IDENTITY',
    description:
        'Hands-on enterprise infrastructure lab focused on designing and managing Windows Server environments with Active Directory, organizational units, Group Policy, DNS, DHCP, DFS, storage, and identity administration.',
    githubUrl: 'YOUR_GITHUB_LINK_HERE',
    tech: [
        'Windows Server',
        'Active Directory',
    ...
    metrics: [
        ...
        { label: 'IDENTITY', value: 'Active Directory' },
        { label: 'SERVICES', value: 'DNS · DHCP · DFS' },
    ],
},
];
...
export const ProjectsSection: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/3 w-[36rem] h-[36rem] bg-[#D4AF37]/5 rounded-full blur-[180px] mobile-performance-blur pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[30rem] h-[30rem] bg-[#8C6D4F]/5 rounded-full blur-[170px] mobile-performance-blur pointer-events-none" />
