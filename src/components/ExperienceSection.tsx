...
const journey: RouteStop[] = [
  {
    id: '01',
    year: 'joined in 26 nov 2025',
    title: 'HCL TECHBEE',
    organization: 'HCLTECH',
    description:
      'Hands-on technology training across enterprise IT, Microsoft 365, identity administration, cloud fundamentals, SQL, Snowflake, and infrastructure technologies.',
  },
  {
    id: '02',
    year: 'Mar 2026 - Jun 2026',
    title: 'DATA ENGINEERING',
    organization: 'SNOWFLAKE / SQL',
    description:
      'Developing practical data engineering skills across Snowflake, SQL, data warehousing, ETL workflows, data quality validation, dimensional modeling, and analytics-ready datasets.',
  },
  {
    id: '03',
    year: ' July 2026',
    title: 'SMARTGRID360',
    organization: 'ENERGY & UTILITY ANALYTICS',
    description:
      'Designed an end-to-end data engineering platform using AWS S3 and Snowflake, covering ingestion, data quality, transformation, warehouse modeling, and analytics layers.',
  },
  {
    id: '04',
    year: 'Aug 2026',
    title: 'ACTIVE DIRECTORY INFRASTRUCTURE LAB',
    organization: 'WINDOWS SERVER / IDENTITY',
    description:
      'Building hands-on enterprise infrastructure environments with Active Directory Domain Services, organizational units, Group Policy, DNS, DHCP, DFS, storage, and Windows Server administration.',
  },
  {
    id: '05',
    year: 'ONGOING',
    title: 'FROM SERVERS TO CLOUD',
    organization: 'CONTINUOUS ENGINEERING',
    description:
      'Continuously expanding across Azure, AWS, identity, infrastructure, data engineering, automation, and modern application development while building practical technology projects.',
  },
];
...
export const ExperienceSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-[#D4AF37]/[0.03] rounded-full blur-[150px] mobile-performance-blur pointer-events-none" />
